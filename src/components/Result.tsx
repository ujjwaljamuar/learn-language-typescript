...
import { countCorrectAnswer } from "../utils/Feature";

// import { countMatchingElements } from "../utils/Feature.ts";
...
const Result = () => {
    ...
    const correctAns = countCorrectAnswer(
        ...
        <Container maxWidth={"sm"}>
            ...
            <Stack direction={"row"} justifyContent={"space-evenly"}>
                ...
                <Stack>
                    ...
                    <List>
                        {words?.map((i, idx) => (
                            <ListItem key={idx}>{i.meaning}</ListItem>
                        ))}
                    </List>
                </Stack>
            </Stack>
